...
if (!$id_periode) { header('Location: data_lab.php'); exit; }
...
if (!$periode) { header('Location: data_lab.php'); exit; }
...
<main class="main">
    ...
    <div class="page-header">
        ...
        <a href="export_riwayat.php?id_periode=<?= $id_periode; ?>" class="btn-primary">
