...
<aside class="sidebar" id="sidebar">
    ...
    <p class="nav-section">Menu</p>
        ...
        <ul style="list-style:none;padding:0;margin:0">
            <li class="nav-item">
                <a class="nav-link" href="lab/data_lab.php">
        ...
        <ul style="list-style:none;padding:0;margin:0">
            <li class="nav-item">
                <a class="nav-link" href="peminjaman/riwayat_pinjam.php">
                    <i class="bi bi-clock-history"></i> Ongoing
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="peminjaman/arsip_peminjaman.php">
        ...
        <ul style="list-style:none;padding:0;margin:0">
            <li class="nav-item">
                <a class="nav-link" href="mahasiswa/data_mhs.php">
                    <i class="bi bi-people-fill"></i> Mahasiswa
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="akun_admin/data_admin.php">
...
<main class="main">
    ...
    <div class="page-header">
        <h1>Dashboard</h1>
        <p>Ringkasan aktivitas peminjaman laboratorium & barang</p>
    </div>

    <!-- Stats -->
    <div class="stats-grid">
        <div class="stat-card card-blue">
            <div class="stat-label"><i class="bi bi-building"></i> Total Lab</div>
            <div class="stat-value"><?= $total_lab ?></div>
        ...
        <div class="stat-card card-green">
            <div class="stat-label"><i class="bi bi-check-circle"></i> Selesai</div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-header-left">
                ...
                <span>Daftar peminjaman dengan status menunggu</span>
            </div>
            <!-- <a href="peminjaman/tambah_data_pinjam.php" class="btn-primary">
            ...
            <table>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="peminjaman/approve_pinjam.php?id=<?= $row['id_data'] ?>" class="btn-detail">
