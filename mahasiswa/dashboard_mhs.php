...
<aside class="sidebar" id="sidebar">
    ...
    <ul style="list-style:none;padding:0;margin:0 0 12px">
        <li class="nav-item">
            <a class="nav-link danger" href="../auth/logout_mhs.php" onclick="return confirm('Yakin ingin logout?')">
...
function loadDashboard() {
    fetch('../ajax/ajax_dashboard_mhs.php')
        .then(response => response.json())
        .then(data => {

            if (data.error) {
                alert("Session habis, silakan login kembali.");
                window.location.href = '../auth/login_mhs.php';
                return;
            }
