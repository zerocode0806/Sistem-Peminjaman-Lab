...
if (!$data) {
    echo "<script>alert('Data tidak ditemukan'); window.location='dashboard_mhs.php';</script>";
    exit;
}
...
if (isset($_POST['update_status'])) {
    ...
    if ($row && $row['status'] === 'disetujui') {
        ...
        try {
            ...
            header("Location: ../admin/peminjaman/checkout_pinjam.php?id=$id&msg=success");
            exit;
...
<div class="page-wrap">
    ...
    <div class="top-nav">
        <nav class="breadcrumb-nav">
            ...
            <a href="riwayat_pinjam_mhs.php">Riwayat</a>
            <i class="bi bi-chevron-right"></i>
            <span class="current">Checkout #<?= $id ?></span>
        </nav>
        <a href="arsip_peminjaman_mhs.php" class="btn-back">
